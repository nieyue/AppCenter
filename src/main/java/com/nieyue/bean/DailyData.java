...
public class DailyData implements Serializable {
	...
	public DailyData(Integer dailyDataId, Long pvs, Long uvs, Long ips,Long readingNumber, Date createDate, Integer appId,Integer acountId) {
		super();
	...
	public String toString() {
		return "DailyData [dailyDataId=" + dailyDataId + ", pvs=" + pvs + ", uvs=" + uvs + ", ips=" + ips
				+ ", readingNumber=" + readingNumber + ", createDate=" + createDate + ", appId=" + appId
				+ ", acountId=" + acountId + "]";
	}
