...
public class Data implements Serializable {
	...
	public Data(Integer dataId, Long pvs, Long uvs, Long ips,Long readingNumber, Date createDate, Integer appId,Integer acountId) {
		super();
		this.dataId = dataId;
		this.pvs = pvs;
		this.uvs = uvs;
	...
	public String toString() {
		return "Data [dataId=" + dataId + ", pvs=" + pvs + ", uvs=" + uvs + ", ips=" + ips + ", readingNumber="
				+ readingNumber + ", createDate=" + createDate + ", appId=" + appId + ", acountId=" + acountId
				+ "]";
	}
