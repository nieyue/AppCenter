...
public class MyDESutil {
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println(md5timestamp);
		 ...
		 String bookOrder2=DigestUtils.md5Hex("118HE9G9H727W67WGGS09D99G8M1").substring(8, 24).toUpperCase();
		System.out.println(bookOrder2);
		
		String book=DigestUtils.md5Hex("19118HE9G9H727W67WGGS09D99G8M1").substring(8, 24).toUpperCase();
