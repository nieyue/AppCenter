...
public class DailyDataServiceImpl implements DailyDataService{
	...
	@Override
	public DailyData loadDailyData(Integer dailyDataId,Date createDate,Integer appId,Integer acountId) {
		DailyData r = dailyDataDao.loadDailyData(dailyDataId,createDate,appId,acountId);
		return r;
	}

	@Override
	public int countAll(Date createDate,Integer appId,Integer acountId) {
		int c = dailyDataDao.countAll(createDate,appId,acountId);
		return c;
	}

	@Override
	public List<DailyData> browsePagingDailyData(Date createDate,Integer appId,Integer acountId,int pageNum, int pageSize,
		...
		List<DailyData> l = dailyDataDao.browsePagingDailyData(createDate,appId,acountId,pageNum-1, pageSize, orderName, orderWay);
		return l;
	}
	@Override
