...
public interface DailyDataDao {
	...
	/** 装载每日数据 */	
	public DailyData loadDailyData(@Param("dailyDataId")Integer dailyDataId,@Param("createDate")Date createDate,@Param("appId")Integer appId,@Param("acountId")Integer acountId);	
	/** 每日数据总共数目 */	
	public int countAll(@Param("createDate")Date createDate,@Param("appId")Integer appId,@Param("acountId")Integer acountId);	
	/** 分页每日数据信息 */
	public List<DailyData> browsePagingDailyData(@Param("createDate")Date createDate,@Param("appId")Integer appId,@Param("acountId")Integer acountId,@Param("pageNum")int pageNum,@Param("pageSize")int pageSize,@Param("orderName")String orderName,@Param("orderWay")String orderWay) ;		
	/** 统计每日数据信息 */
